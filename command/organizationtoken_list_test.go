...
func TestOrganizationTokenListRequiresOrganization(t *testing.T) {
	ui := cli.NewMockUi()
	cmd := &OrganizationTokenListCommand{
		Meta: newTestMeta(ui),
	}
...
func TestOrganizationTokenListHelp(t *testing.T) {
	cmd := &OrganizationTokenListCommand{}
	...
	if !strings.Contains(help, "hcptf organizationtoken list") {
...
func TestOrganizationTokenListSynopsis(t *testing.T) {
	cmd := &OrganizationTokenListCommand{}
	...
	if synopsis != "List organization token" {
		t.Errorf("expected 'List organization token', got %q", synopsis)
	}
}

func TestOrganizationTokenListFlagParsing(t *testing.T) {
	tests := []struct {
		name           string
		args           []string
		expectedOrg    string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			flags := cmd.Meta.FlagSet("organizationtoken list")
