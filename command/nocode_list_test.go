...
func TestNoCodeListCommand_RequiresOrganization(t *testing.T) {
	ui := cli.NewMockUi()
	cmd := &NoCodeListCommand{Meta: newTestMeta(ui)}
...
func TestNoCodeListCommand_FetchesExpectedEndpoint(t *testing.T) {
	...
	cmd := &NoCodeListCommand{Meta: Meta{Ui: ui, client: apiClient}}
