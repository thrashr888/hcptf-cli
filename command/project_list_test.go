...
func TestProjectListRequiresOrganization(t *testing.T) {
	ui := cli.NewMockUi()
...
func TestProjectListHelp(t *testing.T) {
	cmd := &ProjectListCommand{}
	...
	if !strings.Contains(help, "hcptf project list") {
...
func TestProjectListSynopsis(t *testing.T) {
	cmd := &ProjectListCommand{}
	...
	if synopsis != "List projects in an organization" {
		t.Errorf("expected 'List projects in an organization', got %q", synopsis)
	}
}

func TestProjectListFlagParsing(t *testing.T) {
	tests := []struct {
		name        string
		args        []string
		expectedOrg string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			flags := cmd.Meta.FlagSet("project list")
