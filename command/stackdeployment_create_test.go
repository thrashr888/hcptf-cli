...
func TestStackDeploymentCreateRequiresStackID(t *testing.T) {
	ui := cli.NewMockUi()
	cmd := &StackDeploymentCreateCommand{
		Meta: newTestMeta(ui),
	}
...
func TestStackDeploymentCreateHelp(t *testing.T) {
	cmd := &StackDeploymentCreateCommand{}
	...
	if !strings.Contains(help, "hcptf stackdeployment create") {
...
func TestStackDeploymentCreateSynopsis(t *testing.T) {
	cmd := &StackDeploymentCreateCommand{}
	...
	if synopsis != "Trigger a new stack deployment" {
		t.Errorf("expected 'Trigger a new stack deployment', got %q", synopsis)
	}
}

func TestStackDeploymentCreateFlagParsing(t *testing.T) {
	tests := []struct {
		name          string
		args          []string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			flags := cmd.Meta.FlagSet("stackdeployment create")
