...
func TestNoCodeReadCommand_RequiresOrganization(t *testing.T) {
	ui := cli.NewMockUi()
	cmd := &NoCodeReadCommand{Meta: newTestMeta(ui)}
...
func TestNoCodeReadCommand_FetchesExpectedEndpoint(t *testing.T) {
	...
	cmd := &NoCodeReadCommand{Meta: Meta{Ui: ui, client: apiClient}}
